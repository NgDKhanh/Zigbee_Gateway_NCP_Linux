...
void emAfPluginColorControlServerInitCallback(uint8_t init_level);
void emAfPluginEzmodeCommissioningInitCallback(uint8_t init_level);
void emberAfPluginGreenPowerClientInitCallback(uint8_t init_level);
void emAfPluginIdentifyInitCallback(uint8_t init_level);
void emAfPluginManufacturingLibraryCliInitCallback(uint8_t init_level);
...
void emAfPluginTrustCenterNwkKeyUpdateBroadcastInitCallback(uint8_t init_level);

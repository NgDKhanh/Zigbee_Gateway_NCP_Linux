...
void emAfEventInit(void)
{
  ...
  emAfPluginColorControlServerInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  emAfPluginEzmodeCommissioningInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  emberAfPluginGreenPowerClientInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  emAfPluginIdentifyInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  emAfPluginManufacturingLibraryCliInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  ...
  emAfPluginTrustCenterNwkKeyUpdateBroadcastInitCallback(SL_ZIGBEE_INIT_LEVEL_EVENT);

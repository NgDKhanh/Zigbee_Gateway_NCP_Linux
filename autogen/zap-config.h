...
#define GENERATED_ATTRIBUTES { \
  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)3  } }, /* 0 Cluster: Basic, Attribute: cluster revision, Side: client*/ \
	  ...
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 33 Cluster: Green Power, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 34 Cluster: Illuminance Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 35 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 36 Cluster: Pressure Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 37 Cluster: Relative Humidity Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 38 Cluster: IAS Zone, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 39 Cluster: Simple Metering, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 40 Cluster: Electrical Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 41 Cluster: Particle Measurement PM1, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 42 Cluster: Particle Measurement PM2_5, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 43 Cluster: Particle Measurement PM10, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_MANUFACTURER_SPECIFIC| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } } /* 44 Cluster: UV Measurement, Attribute: cluster revision, Side: client*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 1, 0, CLUSTER_MASK_CLIENT, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: client*/ \
	  ...
	  { 0x0400, (EmberAfAttributeMetadata*)&(generatedAttributes[34]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 14, Endpoint Id: 1, Cluster: Illuminance Measurement, Side: client*/ \
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[35]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 15, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0403, (EmberAfAttributeMetadata*)&(generatedAttributes[36]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 16, Endpoint Id: 1, Cluster: Pressure Measurement, Side: client*/ \
	  { 0x0405, (EmberAfAttributeMetadata*)&(generatedAttributes[37]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 17, Endpoint Id: 1, Cluster: Relative Humidity Measurement, Side: client*/ \
	  { 0x0500, (EmberAfAttributeMetadata*)&(generatedAttributes[38]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 18, Endpoint Id: 1, Cluster: IAS Zone, Side: client*/ \
	  { 0x0702, (EmberAfAttributeMetadata*)&(generatedAttributes[39]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 19, Endpoint Id: 1, Cluster: Simple Metering, Side: client*/ \
	  { 0x0B04, (EmberAfAttributeMetadata*)&(generatedAttributes[40]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 20, Endpoint Id: 1, Cluster: Electrical Measurement, Side: client*/ \
	  { 0xFC11, (EmberAfAttributeMetadata*)&(generatedAttributes[41]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 21, Endpoint Id: 1, Cluster: Particle Measurement PM1, Side: client*/ \
	  { 0xFC12, (EmberAfAttributeMetadata*)&(generatedAttributes[42]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 22, Endpoint Id: 1, Cluster: Particle Measurement PM2_5, Side: client*/ \
	  { 0xFC13, (EmberAfAttributeMetadata*)&(generatedAttributes[43]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 23, Endpoint Id: 1, Cluster: Particle Measurement PM10, Side: client*/ \
	  { 0xFC14, (EmberAfAttributeMetadata*)&(generatedAttributes[44]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 24, Endpoint Id: 1, Cluster: UV Measurement, Side: client*/ \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 25, 53 }, \
...
#define GENERATED_COMMANDS { \
  { 0x0000, 0x00, COMMAND_MASK_INCOMING_SERVER }, /* 0, Cluster: Basic, Command: ResetToFactoryDefaults*/ \
	  ...
	  { 0x0500, 0x00, COMMAND_MASK_OUTGOING_CLIENT }, /* 71, Cluster: IAS Zone, Command: ZoneEnrollResponse*/ \
	  { 0x0500, 0x00, COMMAND_MASK_INCOMING_CLIENT }, /* 72, Cluster: IAS Zone, Command: ZoneStatusChangeNotification*/ \
	  { 0x0500, 0x01, COMMAND_MASK_INCOMING_CLIENT }, /* 73, Cluster: IAS Zone, Command: ZoneEnrollRequest*/ \
	  { 0x0702, 0x00, COMMAND_MASK_INCOMING_CLIENT }, /* 74, Cluster: Simple Metering, Command: GetProfileResponse*/ \
	  { 0x0702, 0x01, COMMAND_MASK_INCOMING_CLIENT }, /* 75, Cluster: Simple Metering, Command: RequestMirror*/ \
	  { 0x0702, 0x02, COMMAND_MASK_INCOMING_CLIENT }, /* 76, Cluster: Simple Metering, Command: RemoveMirror*/ \
	  { 0x0702, 0x03, COMMAND_MASK_INCOMING_CLIENT }, /* 77, Cluster: Simple Metering, Command: RequestFastPollModeResponse*/ \
	  { 0x0702, 0x0C, COMMAND_MASK_INCOMING_CLIENT }, /* 78, Cluster: Simple Metering, Command: SupplyStatusResponse*/ \
	 } 
...
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE_CLUSTER_CLIENT
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE25_CLUSTER_CLIENT
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE10_CLUSTER_CLIENT
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_UV_CLUSTER_CLIENT
...
#define EMBER_AF_SAMPLE_MFG_SPECIFIC_PARTICLE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SAMPLE_MFG_SPECIFIC_PARTICLE25_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SAMPLE_MFG_SPECIFIC_PARTICLE10_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SAMPLE_MFG_SPECIFIC_UV_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define ZCL_USING_PRESSURE_MEASUREMENT_CLUSTER_CLUSTER_REVISION_CLIENT_ATTRIBUTE
...
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE_CLUSTER_CLUSTER_REVISION_CLIENT_ATTRIBUTE
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE25_CLUSTER_CLUSTER_REVISION_CLIENT_ATTRIBUTE
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_PARTICLE10_CLUSTER_CLUSTER_REVISION_CLIENT_ATTRIBUTE
#define ZCL_USING_SAMPLE_MFG_SPECIFIC_UV_CLUSTER_CLUSTER_REVISION_CLIENT_ATTRIBUTE
